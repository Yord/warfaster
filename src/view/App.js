...
function FactionImage({ faction }) {
  switch (faction) {
    ...
    case "Universal":
      return <img src={Cyphers} height="80%" />;
    default:
      return <img src={Cyphers} height="80%" />;
  }
}
          ...
          <Content>
            {lists.map((list, index) => (
              <List
                    ...
                    <Col span={12} className="army-list-title">
                      ...
                      >
                        <TextArea
                          ...
                          value="My fancy autogenerated list"
                          maxLength={30}
                          autoSize
                        />
                      </Tooltip>
                ...
                footer={
                  <div>
                    <Badge size="small" key="_badge" count={list.length}>
                ...
                bordered
                dataSource={list}
                renderItem={({ card, type, title, subtype, faction }) => (
                  <List.Item>
                    <List.Item.Meta
                      avatar={
                        <Tag
                          color={
                            (card === "model" ? typeColors : cypherColors)[type]
                          }
                        >
                          {type}
                        </Tag>
